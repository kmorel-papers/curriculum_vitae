...
\begin{document}
  ...
  \begin{cv}{Curriculum Vitae}
    ...
    \item[Conference Chair/Co-Chair]~\\
      \begin{itemize}
      \item
        IEEE Symposium on Large Data Analysis and Visualization (LDAV) 2018.
      \item
        VisLies 2013, 2015, 2016, 2017.
      \end{itemize}
    \item[Program Chair/Co-Chair]~\\
      \begin{itemize}
      \item
        SC Scientific Visualization Showcase 2018.        
      \item
        IEEE Symposium on Large Data Analysis and Visualization (LDAV) 2016, 2017.
      \item
        In Situ Infrastructures for Enabling Extreme-scale Analysis and Visualization (ISAV) 2017.
      \item
    ...
    \item[Program Committee]~\\
      \begin{itemize}
      \item
        International Conference for High Performance Computing, Networking, Storage, and Analysis (SC) 2012, 2013, 2018.
      \item
        EuroVis 2016, 2017, 2018.
      \item
        International Symposium on Visual Computing (ISVC) 2013, 2014, 2018.
      \item
        IEEE Scientific Visualization 2014, 2015, 2016, 2017.
      \item
        Eurographics Symposium on Parallel Graphics and Visualization 2009, 2010, 2011, 2012, 2013, 2015, 2016, 2017.
      \item
        Symposium on Visualization (SIGGRAPH ASIA Symposium) 2017.
      \item
        SC Scientific Visualization Showcase 2017.
      \item
        IEEE Cluster 2015.
      \item
        Visualization in High Performance Computing (SIGGRAPH ASIA workshop) 2015.
      \item
        Large Data Analysis and Visualization (IEEE Vis workshop) 2011, 2013, 2014.
      \item
        Ultrascale Visualization (ACM Supercomputing workshop) 2013, 2014.
      \item
        Big Data Analytics: Challenges and Opportunites (ACM Supercomputing workshop) 2012, 2013.
      \item
        Visualization Infrastructure \& Systems Technology (ACM Supercomputing workshop) 2014.
      \end{itemize}
    \item[Review Panels]~\\
      \begin{itemize}
      \item
